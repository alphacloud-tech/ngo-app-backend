                                            ...
                                            <div class="modal fade" id="editModalCenter{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('event.update', $item->id) }}"
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <select class="custom-select"
                                                                            ...
                                                                            <option value="" selected>Choose organizer
                                                                            </option> <!-- Preselect the default option -->
                                                                            @foreach ($eventOrganizers as $organizer)
                                                                                {{-- <option value="{{ $organizer->id }}"
                                                                                    @if ($organizer->id == $item->organizer->id) selected @endif>
                                                                                    {{ $organizer->name }}
                                                                                </option> --}}
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            value="{{ $item->date }}" name="start_time">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        <label>Location map (<i>Google Iframe</i>)</label>
                                                                        <input type="text" class="form-control"
                                                                            placeholder="" name="location"
                                                                            value="{{ $item->location_map }}">
                                                                    </div>
