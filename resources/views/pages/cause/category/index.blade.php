        ...
        <div class="container-fluid">
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Cause list category</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Cause lists Category</h4>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <form
                                                                action="{{ route('causes-list-category.destroy', $item->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            <div class="modal fade" id="editModalCenter{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('causes-list-category.update', $item->id) }}"
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Edit cause list category</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-12">
                                                                        <label>cause list category name</label>
            ...
            <div class="modal fade" id="exampleModalCenter" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form action="{{ route('causes-list-category.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="modal-header">
                                <h5 class="modal-title">Create cause list category</h5>
