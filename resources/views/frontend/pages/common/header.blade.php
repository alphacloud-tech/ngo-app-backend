        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col d-flex align-items-center contact-info">
                    <div>
                        <i data-feather="phone"></i> <a href="tel:+234(0)807 481 6791">+234(0)807 481 6791</a>
                    </div>
                    <div>
                        <i data-feather="mail"></i>
                        <a href="info@paulsabinnafoundation.com">
                            <span class="" data-cfemail="info@paulsabinnafoundation.com" style="font-size: 10px">
                                info@paulsabinnafoundation.org
                            </span>
                        </a>
                    </div>
                    {{-- <div>
                    ...
                    <div>
                        <i data-feather="map-pin"></i> Naze Industrial Clusters behind Human Race Hospital, Naze/Nekede
                        Road,
                ...
                <div class="col-md-auto">
                    <div class="social-icons">
                        <a target="_blank"
                            href="https://www.facebook.com/profile.php?id=61552554183492&mibextid=LQQJ4d"><i
                                class="icofont-facebook"></i></a>
                        {{-- <a target="_blank" href="#"><i class="icofont-twitter"></i></a> --}}
                        <a target="_blank" href="https://www.instagram.com/paulsabinnafoundation/"><i
                                class="icofont-instagram"></i></a>
                        <a target="_blank" href="https://www.youtube.com/paulsabinnafoundation?gl=BE"><i
    ...
    <nav class="navbar navbar-expand-lg header-fullpage">
        <div class="container text-nowrap">
            ...
            <div class="d-inline-flex request-btn order-lg-last col-auto p-0 align-items-center">
                {{-- <a class="btn-outline-primary btn ms-3" href="#" id="search_home"><i
            ...
            <div class="navbar-collapse">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle-mob" href="{{ route('cause') }}"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('volunteer.become') }}">Become Volunteer</a></li>
